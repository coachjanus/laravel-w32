  ...
  <div class="py-12">
    <form wire:submit="save" class="max-w-sm mx-auto">
            ...
            <div class="mb-5">
                ...
                <input type="text" id="title" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required  wire:model="form.title" />
                <div>
            ...
            <div class="mb-5">
                ...
                <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" wire:model="form.content"></textarea>
