    ...
    <div class="w-full flex justify-between items-center mb-3 mt-1 pl-3">
        ...
        <div class="w-full max-w-sm min-w-[200px] relative">
            ...
            <input
                ...
                placeholder="Search for post..." wire:model.live.debounce.300ms="search"
                />
    ...
    <div class="relative flex flex-col w-full h-full overflow-scroll text-gray-700 bg-white shadow-md rounded-lg bg-clip-border">
        ...
        <tbody>
            ...
            <tr class="hover:bg-slate-50 border-b border-slate-200">
                <td class="p-4 py-5 whitespace-nowrap text-sm font-medium text-gray-800">{{$item->title}}
                </td>
                ...
                <a href="{{ route('admin.posts.update', $item) }}">
                    ...
                    @can('delete', $item)
                    <button type="button" class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900" wire:click="deletePost({{ $item->id }})"  wire:confirm="Are you sure you want to delete this product?">Delete</button>
                    @endcan
