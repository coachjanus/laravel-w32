<div>
    <x-slot name="header">
        ...
        <button type="button" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">All posts</button>
        </a>
        </div>
    </x-slot>
...
<div class="py-12">
  <form wire:submit="save" class="max-w-sm mx-auto">
    ...
    <div class="mb-5">
        ...
        <textarea id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="text description..."  wire:model.live="form.description"></textarea>
    ...
    <fieldset>
      ...
      <div class="flex items-center justify-between mb-4">
        @foreach ($productStatus as $status)
            <input type="radio" wire:model.live="form.status" value="{{$status->value}}" class="w-4 h-4 border-gray-300 focus:ring-2 focus:ring-blue-300" id="status"> 
